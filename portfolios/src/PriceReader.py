...
class PriceReader:
    ...
    def __init__(self,path_to_data="/home/farduh/xcapit/klines/downloaded/"):
    ...
    def get_price_df(self,intervalo,col="close", fecha_inicio = '', fecha_fin = ''):
        ...
        prices_BTC["ETH"]=price["ETHBTC"][col]
        prices_BTC["BNB"]=price["BNBBTC"][col]
        prices_BTC["LTC"]=price["LTCBTC"][col]
